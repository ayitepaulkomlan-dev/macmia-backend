...
METADATA_COLS = {
    "numero_formation_lheo":         "id_formation",
    "code_rncp":                     "rncp",          
    "nom_of":                        "organisme",     
    "nom_region":                    "region",        
    ...
    "prix_ttc_max":                  "prix",
    "cpf_eligible":                  "cpf",
    "modalite_enseignement":         "modalite",
    "duree_formation_heure":         "duree_heures",
    "domaine_sous_domaine":          "domaine",
...
def index_documents(docs):
    ...
    if settings.LLM_PROVIDER == "ollama" or not settings.ANTHROPIC_API_KEY:
        ...
        # Embeddings HuggingFace (sentence-transformers, fonctionne sans Ollama)
        ...
        print("   Modèle embeddings : HuggingFace/all-MiniLM-L6-v2")
